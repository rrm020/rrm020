...
workDir <- "/Users/rileymcdonnell/Desktop/Biology 364/rrm020/HW 7/SARTools/SARTools.edgeR.transcripts.batch"
projectName <- "SARTools.edgeR.transcripts.batch"                         # name of the project
