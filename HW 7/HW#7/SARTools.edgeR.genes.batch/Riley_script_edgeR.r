...
workDir <- "/Users/rileymcdonnell/Desktop/Biology 364/rrm020/HW 7/SARTools/SARTools.edgeR.genes.batch"
projectName <- "SARTools.edgeR.genes.batch"                         # name of the project
