...
They should use multiple pipelines/analyses and compare the results. In this class we have learned that there is a lot of variation in the outputs of these tools, so they should use multiple piplines to check for difference and note which they believed to be the best for their analysis.
