...
They used children who showed symptoms of needing a gastroduodenoscopy evaluated by pediatrician,and had not consumed antibiotics, probiotics, antacid medicine, bismuth, and Chinese medicine with antibacterial effect in past 1 month. Those who tested postive underwent a second gastroduodenoscopy after recieving treatment. The treatment groups went: 
...
There sample size for each group was determined after performing the endoscopy on each child so 55 was their inital number for the study but it was broken down into 37 of them were H pylori-positive (23 nonpeptic
...
They mentionusing Aligent to look at the size and quality of the samples which were then run into Illumina. They used a 300 pb paired-end protocol with Illumina sequencing primers to format their data to prepare them for further analysis. They didn't mention any criteria for the sequencing depth but its seems they used a program to determine the quality and size of the samples. 
...
The illumina files were then converted into FASTQC files, and then run throuhg trimmomatic to cutt of the barcode and primer sequences. Based on the similrity of each sequences they were assigned operational taxonomic units (OTUs). No samples were excluded and from those initial cleaning steps the data went through many other steps looking for bio markers and statistical significance.


5. Mapping program used
Finally, an easy question.
 I believe the mapping program used was PICRUSt because the took their OTU results and put them into this software which then produced most their data.
...
with 52 760 ± 15 204 sequences per sample.The OTUs value was lower in H pylori-positive group (A) (120 ± 65) than that in H pylori-negative group (B) (317 ± 119) and in 4 weeks after therapy group (C) (225.4 ± 107). They used their sequecnes to get profiles an the abundance of gastric microbiota for each treatment group and compare them to the control indivdials as well as make predictions about the pathways from the bacteria found within the microbiota. 
