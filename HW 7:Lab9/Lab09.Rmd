...
Because this experiment was performed on D. melanogaster, a well-studied model organism, there is an annotated genome available for us to use for read alignment.
For non-model organisms we may not have an annotated genome and then other analysis methods must be used (de novo transcriptome assembly).
...
For lab this week you will complete the [Galaxy](1-Galaxy.md) tutorial on Monday and the [SARTools](2-SARTools.md) tutorial on Wednesday. 

For SARTools, you will need the following files from the the RNASeq Group Project section of the Shared Data, Data Libraries tab:
