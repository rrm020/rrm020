...
SRAsummary %>%
 add_row(SampleName = "SRR031711",
   LongName = "S2_DRSC_Untreated-1",
   Layout = "SINGLE",              
   Reads = 6064911,
   Bases = 272.9 * 10^6) %>%
 add_row(SampleName = "SRR031714",
   LongName = "S2_DRSC_Untreated-3",
   Layout = "PAIRED",
   Reads = 5327425,
   Bases = 394.2 * 10^6) %>%
 add_row(SampleName = "SRR031716",
   LongName = "S2_DRSC_Untreated-4",
   Layout = "PAIRED",
   Reads = 5921707,
   Bases = 438.2 * 10^6) %>%
 add_row(SampleName = "SRR031718",
   LongName = "S2_DRSC_CG8144_RNAi-1",
   Layout = "SINGLE",
   Reads = 6724171,
   Bases = 302.6 * 10^6) %>%
 add_row(SampleName = "SRR031724",
   LongName = "S2_DRSC_CG8144_RNAi-3",
   Layout = "PAIRED",
   Reads = 5962418,
   Bases = 441.2 * 10^6) %>%
 add_row(SampleName = "SRR031726",
   LongName = "S2_DRSC_CG8144_RNAi-4",
   Layout = "PAIRED",
   Reads = 6372581,
   Bases = 471.6 * 10^6) -> SRAsummary

# this part ran on my computer perfectly until it just stopped working... I have no idea how to fix it because I didn't change anything from when I started
```
