...
shapiro.test(new.data$station_avg_temp_c)
simple.eda(new.data$station_avg_temp_c)

shapiro.test(new.data$station_precip_mm)
simple.eda(new.data$station_precip_mm)
```
...
shapiro.test(log(new.data$station_avg_temp_c))
simple.eda(log(new.data$station_avg_temp_c))

shapiro.test(sqrt(new.data$station_precip_mm))
simple.eda(sqrt(new.data$station_precip_mm))
```
...
```{r temp and precip}
mean.temp <- log(new.data$station_avg_temp_c)
mean.precip <- sqrt(new.data$station_precip_mm)
```
